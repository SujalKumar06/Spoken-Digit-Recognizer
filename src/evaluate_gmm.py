...
if not os.path.exists('test_data.pkl') or not os.path.exists('gmm_models.pkl'):
    print("run feature_extraction.py and train_gmm.py first")
else:
        ...
        for feature_matrix in test_data[true_str]:
            ...
            for test_digit in range(10):
                ...
                if test_str in models:
                    score = models[test_str].score(feature_matrix)
                    if score > best_score:
                        best_score = score
